...
class Pegawai extends CI_Controller
{
    ...
    public function add_action()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'jab_id'         => $this->input->post('jab_id', TRUE),
    ...
    public function update($id)
    {
        ...
        if ($byid) {
            $data = array(
                ...
                'jab_id' => set_value('jab_id', $byid->jab_id),
    ...
    public function update_action()
    {
        ...
        $this->form_validation->set_rules('jab_id', 'jab_id', 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'jab_id' => ucwords($this->input->post('jab_id', TRUE)),
    ...
    public function _rules()
    {
        ...
        // set rules
        $this->form_validation->set_rules('id_pegawai', 'id', 'trim');
        $this->form_validation->set_rules('nama', 'Nama', 'required');
        $this->form_validation->set_rules('jab_id', 'jab id', 'required');
